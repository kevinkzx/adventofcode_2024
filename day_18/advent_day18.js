...
// we generate our maze by adding the blocks
// actual maze input index goes from 0 to 70. this means that the width and height of actual is 71
let height = 71;
let width = 71;
let maze = [];
...
console.log("after adding blockers");
mazePrint(maze);
...
for (const [key, value] of Object.entries(distances)) {
  if (key === JSON.stringify(goal)) {
    console.log("shortest distance: ", value);
  }
}
